...
BOT_TOKEN="$(python3 -c 'import json,os;t=json.load(open(os.path.expanduser("~/artvision-data/tokens.json")))["telegram"]["portal_bot"];print(t if isinstance(t,str) else t.get("token",""))')"
