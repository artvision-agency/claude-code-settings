...
description: "Комплексный скилл для SEO-агентства: код-ревью, синхронизация, генерация страниц, работа с клиентами, хроника. Commit → /commit. Контент → /content-writer. Триггеры: 'code review', 'ревью', 'sync', 'синхронизация', 'шаблон страницы', 'создай HTML', 'ТЗ', 'RUSH', 'chronicle', 'дневник', 'ревизия скилла'."
---
