...
description: "Expert Python developer: type hints, async/await, dataclasses, modern patterns. Triggers: 'python code', 'python script', 'напиши на python', 'Python best practices'."
---
