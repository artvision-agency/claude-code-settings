...
**Determine the client** from `$ARGUMENTS` (first word = client alias).

**Read client context (Pre-Task Protocol L1):**
```
Read: /Users/antonk/artvision-data/clients/[name]/config.yaml
Glob: /Users/antonk/artvision-data/clients/[name]/patches/*.md
```

Read every patch file to learn from past fixes for THIS client.
...
**If client has CLAUDE.md:**
```
Read: /Users/antonk/artvision-data/clients/[name]/CLAUDE.md
```
...
1. Create directory if it doesn't exist:
   ```bash
   mkdir -p /Users/antonk/artvision-data/clients/[name]/patches
   ```

2. Create a patch file with date and short slug.
   **Format:** `YYYY-MM-DD_short-slug.md` (e.g., `2026-02-12_wrong-meta-title.md`)
