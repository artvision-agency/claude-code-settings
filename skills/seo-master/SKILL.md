...
|--------|----------|--------|
| Информационный | Узнать | "что такое SEO" |
| Навигационный | Найти сайт | "ahrefs вход" |
| Коммерческий | Сравнить | "лучшие SEO инструменты" |
| Транзакционный | Купить | "заказать SEO аудит" |
