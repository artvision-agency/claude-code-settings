---
name: factcheck
description: "Фактчекинг HTML-страниц, КП, отчётов клиентов перед деплоем. 5 слоёв проверки: структура, извлечение данных, кросс-ссылки с ТЗ, HTTP-проверка ассетов, консистентность. Триггеры: фактчек, factcheck, проверь страницу, проверь перед деплоем, validate html, проверь факты"
---
...
5 слоёв автоматической проверки:
